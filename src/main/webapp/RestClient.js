...
// Model for User entity
    models.User = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/webresources/data.user/",
        ...
        toViewJson: function () {
            ...
            result.displayName = this.get('username');
            return result;
        },
        isNew: function () {
        ...
        sync: function (method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/webresources/data.user/';
            }
    ...
    models.UserCollection = Backbone.Collection.extend({
        model: models.User,
        url: "http://localhost:8080/webresources/data.user/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
...
$(function () {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        create: function () {
            ...
            var self = this;
            var dataModel = new models.User();
            // see isNew() method implementation in the model
            dataModel.notSynced = true;
            this.view = new views.ModelView({
                model: dataModel,
                collection: this.collection,
                // tpl-user-details is a template identifier for chosen model element
                templateName: '#tpl-user-details',
